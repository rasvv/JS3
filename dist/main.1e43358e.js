...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/changeForm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.changeForm = void 0;
var currentlyForm = document.querySelectorAll('form');
var currentlyButton = document.querySelectorAll('button');

var changeForm = function changeForm(formName, btnName) {
  currentlyForm.forEach(function (form) {
    form.style.display = 'none';
  });
  currentlyButton.forEach(function (btn) {
...
},{}],"src/diffdates.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.diffToHTML = exports.diffDates = void 0;

var _luxon = require("luxon");

var diffDates = function diffDates(firstDate, secondDate) {
  firstDate = _luxon.DateTime.fromISO(firstDate);
  secondDate = _luxon.DateTime.fromISO(secondDate);

  if (firstDate > secondDate) {
    var _ref = [secondDate, firstDate];
    firstDate = _ref[0];
    secondDate = _ref[1];
  }
...
var _diffdates = require("./diffdates.js");

var _utils = require("./utils.js");

var dateCalcResult = document.getElementById('datecalc__result');

var dateDiff = function dateDiff(event) {
  ...
  if (firstDate && secondDate) {
    var diff = (0, _diffdates.diffDates)(firstDate, secondDate);
    dateCalcResult.innerHTML = (0, _diffdates.diffToHTML)((0, _diffdates.diffDates)(firstDate, secondDate));
...
},{"./diffdates.js":"src/diffdates.js","./utils.js":"src/utils.js"}],"src/howler.js":[function(require,module,exports) {
var define;
...
var buttonRun = document.getElementById("timerBtn");
var timerShow = document.getElementById("timer__result");
var sound = new Howl({
  src: ['./src/sounds/alarm.mp3']
});
var timer = null;

var showText = function showText(str) {
...
var runTimer = function runTimer() {
  ...
  if (buttonRun.innerHTML === 'Старт') {
    ...
    time = time.value * 60; // startTimer;

    timer = setInterval(function () {
      var seconds = time % 60;
      var minutes = time / 60 % 60;
      var hour = time / 60 / 60 % 60;

      if (time <= 0) {
        clearInterval(timer);
        showText((0, _utils.formatError)('Время закончилось!'));
        buttonRun.innerHTML = 'Старт';
        sound.play();
      } else {
        showText("\t\u041E\u0441\u0442\u0430\u043B\u043E\u0441\u044C: \n\t\t\t\t\t".concat(Math.trunc(hour) ? 'Часов: ' + Math.trunc(hour) : ' ', "\n\t\t\t\t\t").concat(Math.trunc(minutes) ? 'Минут: ' + Math.trunc(minutes) : ' ', "\n\t\t\t\t\t").concat(seconds ? 'Секунд: ' + seconds : ' ', "\n\t\t\t\t "));
      }
...
},{"./howler.js":"src/howler.js","./utils.js":"src/utils.js"}],"src/main.js":[function(require,module,exports) {
"use strict";

var _changeForm = require("./changeForm.js");

var _datecalc = require("./datecalc.js");

var _timer = require("./timer.js");

var dateCalcForm = document.getElementById('datecalcform');
var timerForm = document.getElementById('timerform');
var btnCurrentFormCalc = document.getElementById('btnCurrentFormCalc');
var btnCurrentFormTimer = document.getElementById('btnCurrentFormTimer'); // let buttonRun = document.getElementById("timerBtn");

dateCalcForm.addEventListener('submit', function (event) {
  event.preventDefault();
  (0, _datecalc.dateDiff)(event);
});
timerForm.addEventListener('submit', function (event) {
  event.preventDefault();
  (0, _timer.runTimer)();
});
btnCurrentFormCalc.addEventListener('click', function () {
  (0, _changeForm.changeForm)(dateCalcForm, btnCurrentFormCalc);
});
btnCurrentFormTimer.addEventListener('click', function () {
  (0, _changeForm.changeForm)(timerForm, btnCurrentFormTimer);
});
},{"./changeForm.js":"src/changeForm.js","./datecalc.js":"src/datecalc.js","./timer.js":"src/timer.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "10630" + '/');
